...
export class Exame_Utente {
    ...
    @Column({ type: 'datetime' }) //O TypeORM não consegue inferir automaticamente que é uma data, por isso é necessário especificar o tipo explicitamente, caso contrário pode guardar como texto.
    data_exame!: Date;
